    ...
    <div style={{ maxWidth: '400px', margin: 'auto', padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: '15px' }}>
          <label style={{ display: 'block', marginBottom: '5px' }} htmlFor="currentPassword">
            Current Password
          </label>
          <input
            type="password"
        ...
        <div style={{ marginBottom: '15px' }}>
          <label style={{ display: 'block', marginBottom: '5px' }} htmlFor="newPassword">
            New Password
          </label>
          <input
            type="password"
